...
app.post('/user', (req, res) => {
    ...
    const phone = querystring.escape(req.body.phone);
    const credit = querystring.escape(req.body.credit);
    ...
    //Logger user
    logger.info('User: ' + user.name + ' ' + user.phone + ' ' + user.credit + ' ' + user.age);
    // save to mongodb
    user.save().then(item => {
